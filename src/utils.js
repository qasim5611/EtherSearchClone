...
import binanceWallet from "./Components/images/binance.png";
...
const providerOptions = {
  walletconnect: {
    ...
    options: {
      ...
      networkUrl: "https://kovan.infura.io/v3/9aa3d95b3bc440fa88ea12eaa4456161",
      rpc: {
...
export const AppContextProvider = ({ children }) => {
  ...
  const setDarkModeLight = () => {
    setState({
      ...state,
      isDarkMode: false,
    });
  };
  const setDarkModeDark = () => {
    setState({
      ...state,
      isDarkMode: true,
    });
